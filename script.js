...
window.sysLog("Sistema Iniciado. Versión 2.4.1 (Stable)", "info");
...
// ==========================================
// 3. NAVEGACIÓN Y DASHBOARD (Vital)
// ==========================================
...
window.detenerEscaner = function() { 
    if (html5QrCode && html5QrCode.isScanning) { 
        html5QrCode.stop().then(() => { html5QrCode.clear(); }).catch(e=>console.log(e)).finally(() => { if(typeof resetScannerUI === 'function') resetScannerUI(); }); 
    } 
};
...
// ==========================================
// 4. CARGA DE DATOS Y CONEXIÓN (Movid aquí para evitar errores de "undefined")
// ==========================================
...
window.cargarDatosYEntrar = async function(id) {
    ...
    try {
        ...
        // Carga de notificaciones segura
        if(typeof window.suscribirNotificaciones === 'function') window.suscribirNotificaciones(id);
...
window.cambiarAlberguePorQR = async function(aid, pid) { 
    ...
    try { 
        ...
        window.suscribirNotificaciones(aid);
