...
window.cargarObservatorio=async function(){
    ...
    try{
        ...
        for(const ds of sSnap.docs){
            ...
            // FIX: Added 'obs-clickable' and 'onclick'
            h+=`<div class="obs-row"><div class="obs-row-title">${d.nombre}</div><div style="display:flex;width:100%;justify-content:space-between;">
            ...
            <div class="obs-data-point"><span>Libres</span><strong>${sF}</strong></div><div class="obs-data-point"><span>${sP}%</span></div></div></div>`;
        }
