...
// --- 6. CRITICAL UI (MAPA & CAMAS) - MOVIDO AL PRINCIPIO ---
...
// MOVIDO AQUI: Función del Doble Clic para que exista siempre
...
window.mostrarGridCamas = function(){
    ...
    for(let i=1; i<=totalCapacidad; i++){
        ...
        // Aqui llamamos a la funcion que ahora esta definida arriba
