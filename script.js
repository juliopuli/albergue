...
window.sysLog("Sistema Iniciado. Versión 1.0.0 (Base Estable + QR Carnet)", "info");
...
window.verCarnetQR = function() {
    ...
    // Generar QR con el ID único de Firebase
    new QRCode(container, {
        text: personaEnGestion.id,
        width: 250,
        height: 250
    });
