...
// FUNCIONES DE SEGURIDAD UI (TOP PRIORITY)
...
window.suscribirNotificacionesGlobales = async function() {
    ...
    // Traer TODO lo pendiente (filtramos en JS para evitar problemas de índices)
...
window.atenderNotificacion = async function(notifId, personaId, tabDestino) {
    ...
    // RETARDO PARA ASEGURAR CARGA DE FICHA (CLAVE DE LA SOLUCIÓN)
    setTimeout(() => {
...
// ESTA ES LA FUNCIÓN VITAL DE REGISTRO
