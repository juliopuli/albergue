...
window.navegar=(p)=>{
    ...
    if(p==='home'){
        ...
        // document.getElementById('nav-users').classList.add('active'); // Removed from nav
        window.cargarUsuarios(); // Cargar automáticamente al entrar
