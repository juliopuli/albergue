...
window.buscarEnPrefiliacion = async function(){
    ...
    try {
        // Warning: This reads all pool docs client-side filtering. For prod, use queries.
...
window.ingresarDesdeGlobalAction = async function() {
    ...
    try {
        ...
        // Get original pool data to keep family IDs intact if possible, or generate new structure
        // Simplified: Copy form data + status
