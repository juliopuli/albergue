...
window.sysLog("Sistema Iniciado. Versión 2.3.1 (Structure Fixed)", "info");
...
// --- FUNCIONES CRÍTICAS DE INTERFAZ (MOVIDAS AL PRINCIPIO) ---
...
window.suscribirNotificaciones = function(albId) {
    ...
    unsubscribeNotifs = onSnapshot(q, (snapshot) => {
        ...
        // LOG DE QUE HAN LLEGADO DATOS
        window.sysLog(`Snapshot recibido. Documentos: ${snapshot.size}`, "info");
