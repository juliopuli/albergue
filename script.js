...
window.sysLog("Sistema Iniciado. Versión 2.3.2 (Fix QR + Globe)", "info");
...
window.cargarDatosYEntrar = async function(id) {
    ...
    try {
        ...
        // --- NOTIFICACIONES (V2.3.2 - SIMPLIFICADO) ---
...
// --- SISTEMA DE NOTIFICACIONES (V2.3.2) ---
// TRUCO: Solo buscamos por Albergue y filtramos "pendiente" en Javascript para evitar el lío de índices.
window.suscribirNotificaciones = function(albId) {
    ...
    unsubscribeNotifs = onSnapshot(q, (snapshot) => {
        ...
        window.sysLog(`Snapshot: ${snapshot.size} docs`, "info");
