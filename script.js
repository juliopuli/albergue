...
// --- NAVEGACIÓN (MOVIDA AL PRINCIPIO PARA EVITAR ERRORES) ---
...
window.registrarIntervencion = async function(tipo) {
    ...
    const nombrePersona = personaIntervencionActiva.nombre; // Capturar nombre antes de limpiar
