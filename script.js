...
function configurarDashboard(){
    ...
    // NUEVA LÓGICA V3.7.0: Solo admins ven mantenimiento
    if(['super_admin','admin'].includes(r)) m.classList.remove('disabled');
    else m.classList.add('disabled');
...
// --- USUARIOS FIX (V3.7.0 UPDATED ROLES) ---
